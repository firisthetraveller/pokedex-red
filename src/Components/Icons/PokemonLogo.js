...
const PokemonLogo = ({spinning = false, className = ""}) => {
    return (
        <svg width="48" height="48" preserveAspectRatio="xMinYMin meet" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className={`${className} ${spinning ? 'spinning' : ''}`}>
